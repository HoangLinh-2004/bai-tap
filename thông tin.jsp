    ...
    <style>
        ...
        *, *:before, *:after {
        ...
        .edit-checkbox input[type="checkbox"] {
            margin-right: 8px; /* Khoảng cách giữa ô checkbox và chữ */
        }
    </style>
</head>
<body>
    ...
    <form action="Demo1" method="post">
        ...
        <div class="checkbox-label">
            <input type="checkbox" name="typeShip" value="Fast Shipping"> Giao hàng nhanh<br>
            <input type="checkbox" name="typeShip" value="Standard Shipping"> Giao hàng tiêu chuẩn<br>
            <input type="checkbox" name="typeShip" value="Free Shipping"> Giao hàng miễn phí<br>
        </div>

        <!-- Thêm checkbox để hỏi người dùng có muốn chỉnh sửa không -->
        <div class="edit-checkbox">
            <input type="checkbox" id="edit" name="edit" value="yes">
